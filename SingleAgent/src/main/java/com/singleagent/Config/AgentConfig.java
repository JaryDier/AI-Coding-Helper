...
public class AgentConfig {
    ...
    public ReactAgent plannerAgent() {
        return ReactAgent.builder()
                ...
                .description("负责理解用户需求并拆分为可执行任务")
                .systemPrompt(PromptConstant.TASK_PLANNER_AGENT_PROMPT)
    ...
    public ReactAgent codeProgramAgent(
        ...
        return ReactAgent.builder()
                ...
                .hooks(List.of(messageTrimmingHook,shellToolAgentHook))
                .methodTools(fileOperationTool,codeUpdateTool)
                .model(openAiChatModel)
    ...
    //代码执行校验助手
    @Bean
    public ReactAgent codeExecTestAgent(
            ShellToolAgentHook shellToolAgentHook
    ) {
    ...
    public SupervisorAgent supervisorAgent(
            ReactAgent codeReviewAgent,
            ReactAgent codeProgramAgent,
            ReactAgent codeExecTestAgent) {
    ...
    public LlmRoutingAgent llmRoutingAgent(
        ...
        return LlmRoutingAgent.builder()
                ...
                .instruction("""
                        ...
                        """)
                .subAgents(List.of(chatAgent, supervisorAgent))
                .saver(new MemorySaver())
                .build();
    }
